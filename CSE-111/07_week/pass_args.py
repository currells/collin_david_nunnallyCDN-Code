...
*Outline is from 07 Checkpoint: Lists on Canvas
"""
...
"""
a. The modify_args only changed the ii. lx variable.
b. i. Because x is a number and therefore passed to a function by value
c. Because lx is a list and therefore passed to a function by reference
"""