...
# Changes the text color to make certain text stand out
green = "\033[0;32m"
red = "\033[0;31m"
gray = "\033[39m"
...
{green}D means you strongly disagree with the statement.
d means you disagree with the statement.
a means you agree with the statement.
A means you strongly agree with the statement.{gray}
""")
...
def compile_score():
    if score <= 15:
        print(f"{red}A score below 15 may indicate problematic low self-esteem.{gray}")
    else:
        pass
